...
class TotalRecoveriesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          title: Text('Total Recoveries Belgium'),
          centerTitle: true,
